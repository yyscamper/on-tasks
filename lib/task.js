...
function factory(
    ...
    Task.prototype.run = function() {
        ...
        return Promise.resolve()
            ...
            .then(function() {
                if (self.schema) {
                    return validator.validate(self.definition.schemaRef, self.options);
                }
            })
            .then(function() {
                return self._run();
