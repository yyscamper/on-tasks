...
function analyzeOsRepoJobFactory(
    ...
    AnalyzeOsRepoJob.prototype.__findHandle = function(osName) {
        var func_name = '_' + osName + 'Handle';
        var handleFunc = this[func_name];
        ...
        if (!_.isFunction(handleFunc)) { throw(new Error('The handling for ' + osName + ' is not callable.'));                                      }
